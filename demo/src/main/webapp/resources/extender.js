...
if (typeof log === "undefined") {
    log = window.parent && parent.log ? parent.log : console.log;
}
...
if (typeof MonacoEnvironment === "object" && window.parent) {
    switch (new URL(document.currentScript.src).searchParams.get("type")) {
        case "basic-true":
            MonacoEnvironment.Extender = createExtenderBasic(true);
            break;
        case "basic-false":
            MonacoEnvironment.Extender = createExtenderBasic(false);
            break;
        default:
            MonacoEnvironment.Extender = createExtender(false);
    }
}
